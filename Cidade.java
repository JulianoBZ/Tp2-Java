    ...
    public void cadastrarCidade(){
        ...
        try{
            ...
            for (int i = 0; i < lista.size();i++){
                if(lista.get(i).equals(nome.toUpperCase())){
        ...
        try{
            ...
            if(lista.isEmpty()){
                ...
                for (int i = 0; i < nomesCidades.size()-1; i++){
                    ...
                    if ( (nomesCidades.get(i).equals(nomesCidades.get(i+1))) == false ){
                        lista.add(nomesCidades.get(i));
                    }
                }

                
                //Adicionando o último item da lista, pois ele não tem com quem ser comparado ao final
                lista.add(nomesCidades.get(nomesCidades.size()-1));
